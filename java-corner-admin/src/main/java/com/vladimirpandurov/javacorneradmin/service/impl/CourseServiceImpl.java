...
import com.vladimirpandurov.javacorneradmin.dao.CourseDao;
import com.vladimirpandurov.javacorneradmin.dao.InstructorDao;
import com.vladimirpandurov.javacorneradmin.dao.StudentDao;
...
import com.vladimirpandurov.javacorneradmin.mapper.CourseMapper;
...
public class CourseServiceImpl implements CourseService {
    ...
    public void assignStudentToCourse(Long courseId, Long studentId) {
        Student student = studentDao.findById(studentId).orElseThrow(()-> new EntityNotFoundException("Student with ID " + courseId + " Not Found"));
